...
let cts = function White -> "White " | Yellow -> "Yellow " | Red -> "Red " | Orange -> "Orange " | Blue -> "Blue " | Green -> "Green "
...
let cube_to_string = function
  | [| a; b; c; d; e; f |] ->
      "Face 1: " ^ face_to_string a ^ "Face 2: " ^ face_to_string b ^ "Face 3: " ^ face_to_string c ^ "Face 4: " ^ face_to_string d ^ "Face 5: "
      ^ face_to_string e ^ "Face 6: " ^ face_to_string f
  | _ -> failwith "invalid"

let face_copy = function [| a; b; c; d; e; f; g; h; i |] -> [| a; b; c; d; e; f; g; h; i |] | _ -> failwith "invalid"
...
let turn_test (name : string) input1 input2 : test = name >:: fun _ -> assert_equal input1 input2 ~printer:cube_to_string
let undo_test (name : string) input : test = name >:: fun _ -> assert_equal true input
...
let u'_tests =
  [
    ...
    turn_test "testing two u' turns on the default cube (i.e., one u' turn from\n  the cube in the state directly after one u' turn)" u'_u'_cube
      (init_cube_two_turns u'_turn u'_turn 0);
    undo_test "one u turn on the cube that has made a u' turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let f_tests =
  [
    ...
    undo_test "one f' turn on the cube that has made a f turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let d_tests =
  [
    ...
    undo_test "one d' turn on the cube that has made a d turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let b_tests =
  [
    ...
    undo_test "one b' turn on the cube that has made a b turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let r_tests =
  [
    ...
    undo_test "one r' turn on the cube that has made a r turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let l_tests =
  [
    ...
    undo_test "one l' turn on the cube that has made a l turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let l'_tests =
  [
    ...
    undo_test "one l turn on the cube that has made an l' turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let m_tests =
  [
    ...
    undo_test "one m' turn on the cube that has made an m turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let e_tests =
  [
    ...
    undo_test "one e' turn on the cube that has made an e turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let s_tests =
  [
    ...
    undo_test "one s' turn on the cube that has made an s turn should be equivalent default cube (i.e., the state that hasn't changed)"
...
let y_tests =
  [
    ...
    undo_test "one y' rotate on the cube that has made a y rotate should be equivalent default cube (i.e., the state that hasn't changed)"
...
let x_tests =
  [
    ...
    undo_test "one x' rotate on the cube that has made an x rotate should be equivalent default cube (i.e., the state that hasn't changed)"
...
let z_tests =
  [
    ...
    undo_test "one z' rotate on the cube that has made a z rotate should be equivalent default cube (i.e., the state that hasn't changed)"
